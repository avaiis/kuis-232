...
import 'package:kuis_232/pages/home_page.dart';
...
class _LoginPageState extends State<LoginPage> {
  ...
  void _login() {
    ...
    // validasi data
    if (_usernameController.text == "232" &&
        _passwordController.text == "kuis_232") {
      // snackbar succes
  ...
  Widget _buildLogo(Color color) {
    return Positioned(
      ...
      child: Column(children: [Image.asset('images/logo.png', height: 150)]),
    );
  }
